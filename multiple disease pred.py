...
diabetes_model = pickle.load(open('C:/Users/Asus/Desktop/New folder/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('C:/Users/Asus/Desktop/New folder/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('C:/Users/Asus/Desktop/New folder/parkinsons_model.sav', 'rb'))

breastcancer_model = pickle.load(open('C:/Users/Asus/Desktop/New folder/BreastCancer_model.sav','rb'))
...
if (selected == "Breast Cancer"):
    ...
    with col5:
        fractal_dimenstion_mean=st.text_input('Fractal_Dimenstion_Mean')    
    with col4:
    ...
    with col2:
        fractal_dimenstion_se = st.text_input('fractal_dimenstion_se')
    ...
    with col4:
        fractal_dimenstion_worst = st.text_input('fractal_dimenstion_worst')
    with col5:
    ...
    if st.button("Breast Cancer's Test Result"):
        Breast_Cancer_prediction = breastcancer_model.predict([[radius_mean, texture_mean, perimeter_mean, area_mean, smoothness_mean, compactness_mean, concavity_mean,concave_points_mean,symmetry_mean,fractal_dimenstion_mean,texture_se ,perimeter_se,area_se,smoothness_se,compactness_se,concavity_se ,concave_points_se,symmetry_se,fractal_dimenstion_se,radius_worst,area_worst,smoothness_worst,compactness_worst,concavity_worst,concave_points_worst,symmetry_worst,fractal_dimenstion_worst]])                          
        
        if (Breast_Cancer_prediction[0] == 1):
          Breast_Cancer = "The person has Breast Cancer disease"
        else:
          Breast_Cancer= "The person does not have Breast Cancer disease"
        
    st.success(Breast_Cancer)
